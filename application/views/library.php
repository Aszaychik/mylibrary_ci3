...
?>
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('https://picsum.photos')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <h1>Welcome to Library</h1>
                            <span class="subheading">A Library using CI3 by <a class="fw-bold" href="https://github.com/Aszaychik">Kelompok 7</a></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="post-preview">
						...
						<div class="my-5">
							...
							<figure class="d-flex justify-content-center align-items-center flex-column gap-5 my-3">
								<img class="img-fluid img-thumbnail w-50" src="<?= base_url("uploads/thumbs/". $book['thumb']);?>" alt="test">
								<figcaption class="">
									<?= $book["description"];?>
								</figcaption>
							</figure>
